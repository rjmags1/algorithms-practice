...
## Notes
- This problem can be annoying to get right implementation-wise, and conceptually it is subtle to understand because even if you build the correct system of equations needed to derive the correct conceptual approach, actually deriving the correct conceptual approach from the equations is tricky because it requires a bit of interpretation beyond saying "ok this variable equals that variable/equation".
